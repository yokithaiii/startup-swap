      ...
      <section className="py-20 md:py-28">
        <div className="container max-w-3xl">
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              StartupSwap решает это: верификация за 24–48 часов, AI-оценка стоимости, поиск по tech stack и структурированный процесс передачи. Мы делаем покупку и продажу проектов такой же простой, как покупка на маркетплейсе.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { title: 'Безопасность', desc: 'Платформа фиксирует этапы передачи. Обе стороны подтверждают каждый шаг сделки.' },
