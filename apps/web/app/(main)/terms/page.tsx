    ...
    <div className="container ml-auto mr-auto py-16 md:py-24 max-w-3xl">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>Эскроу-комиссия составляет 2.5% от суммы сделки и покрывает услуги по безопасному проведению транзакции.</p>
        </section>

        <div className="h-px bg-border" />

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-foreground">5. Эскроу и сделки</h2>
          <p>Все сделки проводятся через эскроу-систему. Средства замораживаются до выполнения всех этапов передачи проекта.</p>
          <p>В случае спора между сторонами StartupSwap выступает арбитром и принимает решение на основании предоставленных доказательств.</p>
        </section>
