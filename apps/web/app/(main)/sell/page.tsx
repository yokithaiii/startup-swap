          ...
          <div className="mx-auto max-w-3xl space-y-4">
            {[
              ...
              },
              {
                ...
                desc: 'Договоритесь об условиях с покупателем. Поэтапно передайте проект через платформу.',
              },
        ...
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: Shield, title: 'Структурированная сделка', desc: 'Платформа фиксирует этапы передачи. Обе стороны видят прогресс и подтверждают выполнение.' },
