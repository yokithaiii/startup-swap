...
export const metadata: Metadata = {
  ...
  description: 'Найдите прибыльный технологический проект для покупки. SaaS, AI, e-commerce с реальными метриками и подтверждённой выручкой.',
  openGraph: {
    title: 'Купить готовый проект — каталог верифицированных стартапов',
          ...
          <div className="mx-auto max-w-3xl space-y-4">
            {[
              ...
              },
              {
                ...
                desc: 'Поэтапная передача через платформу. Вы получаете код, домен, аккаунты и поддержку.',
              },
        ...
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: Shield, title: 'Структурированная передача', desc: 'Платформа фиксирует этапы передачи. Вы подтверждаете каждый шаг перед завершением сделки.' },
