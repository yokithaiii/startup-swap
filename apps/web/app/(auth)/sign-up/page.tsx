...
import { Rocket, ArrowRight, TrendingUp, Shield, Zap, CheckCircle2, Loader2 } from 'lucide-react'
        ...
        <div className="relative space-y-8">
          ...
          <div className="rounded-lg border border-white/10 bg-white/5 p-4">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Размещение бесплатно. Берём 10% только после успешной сделки.
            </p>
          </div>
        </div>
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm space-y-8">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Это займёт меньше минуты</p>
          </div>
